...
class TOTP8DigitsSha512Test(private var input: Int, private var expected: String) {
    private val period = 30
    private val digits = 8

    // HMAC-SHA1 - 64 bytes
    private val secret = "35464233453539304537374245364632333036434241364334453845384534453144343046453733303843373146463030353042363944323133424546343541"
